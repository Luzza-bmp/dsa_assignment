...
Creates a linked list with 5 nodes (10, 20, 30, 40, 50)
Displays the list in normal order (forward)
Displays the list in reverse order (backward)
Explains how the reverse traversal works
...
Needs a base case to stop (NULL in our case)
Uses the call stack to remember where to return
...
free() releases memory when done
